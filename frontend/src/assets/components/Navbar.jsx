      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/staff/dashboard" className="text-xl font-bold tracking-tight">
              Courier System – Staff
            </Link>
          </div>
          <div className="flex items-center gap-8">
            <Link to="/staff/parcels" className="hover:text-blue-300 transition font-medium">
              Parcels
            </Link>
            <button
